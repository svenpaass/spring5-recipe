...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private List<Recipe> getRecipes() {
    ...
    tacosRecipe.getIngredients().add(new Ingredient("boneless chicken thighs", new BigDecimal(4), eachUom, tacosRecipe));
    ...
    tacosRecipe.getIngredients().add(new Ingredient("red onion, thinly sliced", new BigDecimal(0.25), eachUom, tacosRecipe));
    tacosRecipe.getIngredients().add(new Ingredient("roughly chopped cilantro", new BigDecimal(1), eachUom, tacosRecipe));
    tacosRecipe.getIngredients().add(new Ingredient("sour cream thinned with 1/4 cup milk", new BigDecimal(0.5), cupsUom, tacosRecipe));
