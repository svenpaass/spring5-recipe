...
import net.paass.spring5recipe.domain.Difficulty;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private List<Recipe> getRecipes() {
    ...
    Optional<UnitOfMeasure> cupsSpoonUomOptional = unitOfMeasureRepository.findByDescription("Cup");
    ...
    guacRecipe.addIngredient(new Ingredient("ripe avocados", new BigDecimal(2), eachUom))
        ...
        .addIngredient(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(2), eachUom));
    ...
    tacosRecipe.addIngredient(new Ingredient("Ancho chili powder", new BigDecimal(2), tableSpoonUom))
        ...
        .addIngredient(new Ingredient("Salt", new BigDecimal(0.5), teaSpoonUom))
        .addIngredient(new Ingredient("Clove of Garlic, Chopped", new BigDecimal(1), eachUom))
        ...
        .addIngredient(new Ingredient("boneless chicken thighs", new BigDecimal(4), eachUom))
        ...
        .addIngredient(new Ingredient("red onion, thinly sliced", new BigDecimal(0.25), eachUom))
        .addIngredient(new Ingredient("roughly chopped cilantro", new BigDecimal(1), eachUom))
        .addIngredient(new Ingredient("sour cream thinned with 1/4 cup milk", new BigDecimal(0.5), cupsUom))
